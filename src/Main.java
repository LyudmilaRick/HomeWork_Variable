public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Сочетание CTRL ALT L в IDEA поправит форматирование до стандартных каноничных видов.
        byte age = 54;
        short ageMonth = 648;
        int ageDays = 19440;
        ...
        //  Задача 3.
        // всегда в таких ситуациях (когда работают с целыми числами) используют int, иногда long, если значение не влезает в int.
        int weightBanana = 80;    // short weightBanana = 80;
        int weightMilk = 105;     // short weightMilk = 105;
        int weightCream = 100;   //  short weightCream = 100;
        int weightEgg = 70;      // short weightEgg = 70;
        ...
        int valuePersant  = 10;
        float calcPersant = (100 + valuePersant * 1.00f)/100;
        float newSalaryMary = oldSalaryMary * calcPersant;
        float newSalaryDen  = oldSalaryDen  * calcPersant;
        float newSalaryKris = oldSalaryKris * calcPersant;
        ...
        result = -result; //result = minus * result;
